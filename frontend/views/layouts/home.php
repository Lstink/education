...
<head>
	...
	<script scr='statics/js/jquery-3.2.1.min.js'></script>
	<script src="statics/js/jquery-1.8.0.min.js"></script>
	<script type="text/javascript" src="statics/js/rev-setting-1.js"></script>
	<script type="text/javascript" src="statics/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
	<link rel="stylesheet" href="statics/css/style.css" />
	<link rel="stylesheet" href="statics/css/tab.css" media="screen">
	<link rel="stylesheet" type="text/css" href="statics/css/main.css" id="main-css">
	<!--课程选项卡-->
...
<body>
	...
	<div class="head" id="fixed">
		<div class="nav">
			<span class="navimg"><a href="<?= Url::to(['/']) ?>"><img border="0" src="statics/images/logo.png"></a></span>
			<ul class="nag">
	...
	<div class="content">
		...
		<div class="foot">
			<div class="fcontainer">
				<div class="fwxwb">
					<div class="fwxwb_1">
						<span>关注微信</span><img width="95" alt="" src="statics/images/num.png">
					</div>
					<div>
						<span>关注微博</span><img width="95" alt="" src="statics/images/wb.png">
					</div>
				</div>
				<div class="fmenu">
		...
		<div class="rmbar">
			...
			<span class="barico em" style="position:relative">
				<img src="statics/images/num.png" width="75" class="showem">
			</span>
			<span class="barico wb" style="position:relative">
				<img src="statics/images/wb.png" width="75" class="showwb">
			</span>
